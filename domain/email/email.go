...
func (s *service) buildHtmlBody(activities []domain.Activity) string {
	...
	for _, act := range activities {
		tableLines += `<tr>
		<td style="width: 20.7562%; border: 1px solid rgb(96, 96, 96); text-align: center;">` + act.Name + `</td>
		<td style="width: 14.9691%; border: 1px solid rgb(96, 96, 96); text-align: center;">` + act.WeekDay + `</td>
		<td style="width: 11.7525%; border: 1px solid rgb(96, 96, 96); text-align: center;">` + fmt.Sprintf("%s - %s", act.StartDate.Format("3:04 PM"), act.EndDate.Format("3:04 PM")) + `</td>
		<td style="width: 18.5258%; border: 1px solid rgb(96, 96, 96); text-align: center;">` + act.StartDate.Format("Jan-02-2006") + `</td>
		<td style="width: 13.6791%; border: 1px solid rgb(96, 96, 96); text-align: center;">` + act.AvailableSpots + `</td>
		<td style="width: 13.6791%; border: 1px solid rgb(96, 96, 96); text-align: center;">` + `<a href="` + act.Url + `">link</a>` + `</td>
		</tr>`
	}
	htmlBody := `<p>Hello!</p>
	...
	<table style="width: 100%; border-collapse: collapse; border: 1px solid rgb(96, 96, 96);">
		<thead>
			<tr>
				<th style="width: 20.7562%; border: 1px solid rgb(96, 96, 96);">Activity Name</th>
				...
				<th style="width: 13.6791%; border: 1px solid rgb(96, 96, 96);">Link</th>
			</tr>
		</thead>
		<tbody>
			` + tableLines + `
